...
export function handleActiveEmergencyMode(event: ActiveEmergencyModeEvent): void {
  let entity = new ActiveEmergencyMode(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleAddSymbol(event: AddSymbolEvent): void {
  let entity = new AddSymbol(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleDeactiveEmergencyMode(event: DeactiveEmergencyModeEvent): void {
  let entity = new DeactiveEmergencyMode(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleDeregisterPartyB(event: DeregisterPartyBEvent): void {
  let entity = new DeregisterPartyB(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handlePauseAccounting(event: PauseAccountingEvent): void {
  let entity = new PauseAccounting(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handlePauseGlobal(event: PauseGlobalEvent): void {
  let entity = new PauseGlobal(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handlePauseLiquidation(event: PauseLiquidationEvent): void {
  let entity = new PauseLiquidation(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handlePausePartyAActions(event: PausePartyAActionsEvent): void {
  let entity = new PausePartyAActionsE(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handlePausePartyBActions(event: PausePartyBActionsEvent): void {
  let entity = new PausePartyBActionsE(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleRegisterPartyB(event: RegisterPartyBEvent): void {
  let entity = new RegisterPartyB(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetBalanceLimitPerUser(event: SetBalanceLimitPerUserEvent): void {
  let entity = new SetBalanceLimitPerUser(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetCollateral(event: SetCollateralEvent): void {
  let entity = new SetCollateral(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetDeallocateCooldown(event: SetDeallocateCooldownEvent): void {
  let entity = new SetDeallocateCooldown(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetForceCancelCloseCooldown(event: SetForceCancelCloseCooldownEvent): void {
  let entity = new SetForceCancelCloseCooldown(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetForceCancelCooldown(event: SetForceCancelCooldownEvent): void {
  let entity = new SetForceCancelCooldown(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetForceCloseCooldown(event: SetForceCloseCooldownEvent): void {
  let entity = new SetForceCloseCooldown(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetForceCloseGapRatio(event: SetForceCloseGapRatioEvent): void {
  let entity = new SetForceCloseGapRatio(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetLiquidationTimeout(event: SetLiquidationTimeoutEvent): void {
  let entity = new SetLiquidationTimeout(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetLiquidatorShare(event: SetLiquidatorShareEvent): void {
  let entity = new SetLiquidatorShare(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetMuonConfig(event: SetMuonConfigEvent): void {
  let entity = new SetMuonConfig(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetMuonIds(event: SetMuonIdsEvent): void {
  let entity = new SetMuonIdsE(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetPartyBEmergencyStatus(event: SetPartyBEmergencyStatusEvent): void {
  let entity = new SetPartyBEmergencyStatusE(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetPendingQuotesValidLength(event: SetPendingQuotesValidLengthEvent): void {
  let entity = new SetPendingQuotesValidLength(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetSuspendedAddress(event: SetSuspendedAddressEvent): void {
  let entity = new SetSuspendedAddressE(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetSymbolAcceptableValues(event: SetSymbolAcceptableValuesEvent): void {
  let entity = new SetSymbolAcceptableValuesE(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetSymbolFundingState(event: SetSymbolFundingStateEvent): void {
  let entity = new SetSymbolFundingState(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetSymbolMaxLeverage(event: SetSymbolMaxLeverageEvent): void {
  let entity = new SetSymbolMaxLeverage(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetSymbolMaxSlippage(event: SetSymbolMaxSlippageEvent): void {
  let entity = new SetSymbolMaxSlippage(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetSymbolTradingFee(event: SetSymbolTradingFeeEvent): void {
  let entity = new SetSymbolTradingFee(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetSymbolValidationState(event: SetSymbolValidationStateEvent): void {
  let entity = new SetSymbolValidationState(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleUnpauseAccounting(event: UnpauseAccountingEvent): void {
  let entity = new UnpauseAccounting(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleUnpauseGlobal(event: UnpauseGlobalEvent): void {
  let entity = new UnpauseGlobal(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleUnpauseLiquidation(event: UnpauseLiquidationEvent): void {
  let entity = new UnpauseLiquidation(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleUnpausePartyAActions(event: UnpausePartyAActionsEvent): void {
  let entity = new UnpausePartyAActionsE(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleUnpausePartyBActions(event: UnpausePartyBActionsEvent): void {
  let entity = new UnpausePartyBActionsE(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleDisputeForLiquidation(event: DisputeForLiquidationEvent): void {
  let entity = new DisputeForLiquidation(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleFullyLiquidatedPartyB(event: FullyLiquidatedPartyBEvent): void {
  let entity = new FullyLiquidatedPartyB(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleLiquidatePartyA(event: LiquidatePartyAEvent): void {
  let entity = new LiquidatePartyA(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleLiquidatePartyB(event: LiquidatePartyBEvent): void {
  let entity = new LiquidatePartyB(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleLiquidatePendingPositionsPartyA(event: LiquidatePendingPositionsPartyAEvent): void {
  let entity = new LiquidatePendingPositionsPartyA(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleLiquidatePositionsPartyA(event: LiquidatePositionsPartyAEvent): void {
  let entity = new LiquidatePositionsPartyA(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleLiquidatePositionsPartyB(event: LiquidatePositionsPartyBEvent): void {
  let entity = new LiquidatePositionsPartyB(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleLiquidationDisputed(event: LiquidationDisputedEvent): void {
  let entity = new LiquidationDisputed(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSetSymbolsPrices(event: SetSymbolsPricesEvent): void {
  let entity = new SetSymbolsPricesE(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSettlePartyALiquidation(event: SettlePartyALiquidationEvent): void {
  let entity = new SettlePartyALiquidation(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleExpireQuote(event: ExpireQuoteEvent): void {
  let entity = new ExpireQuote(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleForceCancelCloseRequest(event: ForceCancelCloseRequestEvent): void {
  let entity = new ForceCancelCloseRequest(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleForceCancelQuote(event: ForceCancelQuoteEvent): void {
  let entity = new ForceCancelQuote(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleForceClosePosition(event: ForceClosePositionEvent): void {
  let entity = new ForceClosePosition(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleRequestToCancelCloseRequest(event: RequestToCancelCloseRequestEvent): void {
  let entity = new RequestToCancelCloseRequest(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleRequestToCancelQuote(event: RequestToCancelQuoteEvent): void {
  let entity = new RequestToCancelQuote(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleRequestToClosePosition(event: RequestToClosePositionEvent): void {
  let entity = new RequestToClosePosition(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleSendQuote(event: SendQuoteEvent): void {
  let entity = new SendQuote(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleAllocateForPartyB(event: AllocateForPartyBEvent): void {
  let entity = new AllocateForPartyB(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleAllocatePartyA(event: AllocatePartyAEvent): void {
  let entity = new AllocatePartyA(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleDeallocateForPartyB(event: DeallocateForPartyBEvent): void {
  let entity = new DeallocateForPartyB(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleDeallocatePartyA(event: DeallocatePartyAEvent): void {
  let entity = new DeallocatePartyA(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleTransferAllocation(event: TransferAllocationEvent): void {
  let entity = new TransferAllocation(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleAcceptCancelCloseRequest(event: AcceptCancelCloseRequestEvent): void {
  let entity = new AcceptCancelCloseRequest(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleAcceptCancelRequest(event: AcceptCancelRequestEvent): void {
  let entity = new AcceptCancelRequest(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleAllocatePartyB(event: AllocatePartyBEvent): void {
  let entity = new AllocatePartyB(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleChargeFundingRate(event: ChargeFundingRateEvent): void {
  let entity = new ChargeFundingRate(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleEmergencyClosePosition(event: EmergencyClosePositionEvent): void {
  let entity = new EmergencyClosePosition(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleFillCloseRequest(event: FillCloseRequestEvent): void {
  let entity = new FillCloseRequest(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleLockQuote(event: LockQuoteEvent): void {
  let entity = new LockQuote(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleOpenPosition(event: OpenPositionEvent): void {
  let entity = new OpenPosition(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
...
export function handleUnlockQuote(event: UnlockQuoteEvent): void {
  let entity = new UnlockQuote(event.transaction.hash.concatI32(event.logIndex.toI32()));
  let cId = CounterId.load("main");
  if (!cId) {
    cId = new CounterId("main");
    cId.eventId = 0;
